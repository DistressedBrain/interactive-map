...
(function () {
  ...
  list.forEach(function (w, i) {
    ...
    if (w.media && w.media.toLowerCase().endsWith(".mp4")) {
      ...
      // number by position in widgets.js, so it stays true to the card's
      // "Plate NN" tag even after reordering in the dev editor
      const num = WIDGETS.indexOf(w) + 1;
      inner += '<div class="w-blob"></div><div class="w-num">' + String(num).padStart(2, "0") + "</div>";
    }
